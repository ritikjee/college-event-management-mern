...
function Loginpage({ setShowLoginModal }) {
    ...
    return (
        <>
        <div className="h-screen w-screen z-20 bg-black fixed inset-0 bg-opacity-50">
            ...
            <div className=" md:w-[350px] lg:w-[500px] bg-white rounded-2xl px-5 py-5  max-[400px] shadow-2xl">
                ...
                <div className=" text-center p-8">
                    ...
                    <span className=" hover:cursor-pointer hover:scale-125 transform transition-all text-[#2270E2]"> Sign up</span>
